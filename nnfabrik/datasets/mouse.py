...
def mouse_static_loader(
    path, batch_size, img_seed=None, area="V1", layer="L2/3", tier=None, neuron_ids=None, get_key=False, cuda=True
):
    """
    ...
    conds = (dat.neurons.area == area) & (dat.neurons.layer == layer) & (np.isin(dat.neurons.unit_ids, neuron_ids))
...
def mouse_static_loaders(
    paths, batch_size, img_seed=None, area="V1", layer="L2/3", tier=None, neuron_ids=None, cuda=True
):
    """
