...
[Here](./notebooks/nnfabrik_example.ipynb), we provided an example of the whole pipeline which might help to understand how different components work together to perform hyper-parameter search.
